...
- общий объём: 200 подписок;
- одна партия: 50 подписок;
...
| --- | --- |
| 49 занятых мест | партия 1, остаток 1, цена 19 800 ₽ |
| 50 занятых мест | партия 2, остаток 50, цена 23 800 ₽ |
...
пишет `PAYMENT_PENDING`, поэтому конкурентные запросы на границе 50 мест нельзя
