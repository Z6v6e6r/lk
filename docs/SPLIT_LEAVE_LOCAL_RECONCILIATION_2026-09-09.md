...
оставляют восстановление неподтверждённым. Новый booking не отменяется фоновым
восстановлением; явный выход игрока с атрибутируемой живой записью по exercise этой игры
отменяет её штатным путём — см. `docs/SPLIT_LEAVE_ACTIVE_VIVA_DEMOTION_2026-09-11.md`.
