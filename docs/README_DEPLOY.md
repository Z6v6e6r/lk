...
`fixedActivationAt=2026-09-30T21:00:00.000Z`. Он ещё не выпущен и не активирует
экземпляры сам: до provider-confirmed перехода и фонового дедлайна экземпляр
`PENDING_ACTIVATION` остаётся fail closed в ЛК.
