...
в `Europe/Moscow`; 365 дней отсчитываются от фактической активации. Текущий
контракт ЦУП не выражает эту комбинацию одним lifecycle mode, поэтому её нельзя
подменять `effectiveAt` или публиковать как один из существующих режимов.
