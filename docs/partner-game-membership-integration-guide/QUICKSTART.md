...
участника. Пока боевой endpoint не выдан, шаги 0 проверяются офлайн, а шаги 3–5
показывают точную форму запросов: подставьте выданный базовый URL, `clientId`,
`keyId`, секрет и mTLS-сертификат.
