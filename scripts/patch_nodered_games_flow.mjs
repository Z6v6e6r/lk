...
const srcCandidates = cliSrcPath
  ? [cliSrcPath]
  : [
      '/Users/zver/Desktop/project-fixed 6/node-red/22_05_26.json',
...
const fnSplitLeavePrepare = readFn('fn_split_leave_prepare.js');
const fnSplitLeaveRouter = readFn('fn_split_leave_router.js');
...
const fnCompositeOptions = readFn('fn_composite_options.js');
const fnCompositeCreate = readFn('fn_composite_create.js');
const fnCompositeConfirmQuery = readFn('fn_composite_confirm_query.js');
const fnCompositeConfirmApply = readFn('fn_composite_confirm_apply.js');
const fnTournamentSubscriptionCounterRefreshPrepare = readFn('fn_tournament_subscription_counter_refresh_prepare.js');
const fnTournamentSubscriptionCounterRefreshResponse = readFn('fn_tournament_subscription_counter_refresh_response.js');
const fnTournamentSubscriptionStatusPrepare = readFn('fn_tournament_subscription_status_prepare.js');
const fnTournamentSubscriptionStatusResponse = readFn('fn_tournament_subscription_status_response.js');
...
const LEGACY_GAME_ROUTE_URLS = new Set([
  ...
  '/lk/games/:gameId/split/leave',
  '/lk/games/split/cleanup',
  '/lk/tournaments/summer-subscription/status',
  '/lk/tournaments/summer-subscription/purchase',
  '/lk/tournaments/summer-subscription/confirm',
]);
...
const newNodes = [
  ...
  },
  {
    ...
    x: 470,
    y: 1880,
    wires: [['d4a011b9337a4207'], ['d4a011b9337a4209'], ['d4a011b9337a4210'], ['d4a011b9337a4208']],
  },
  {
    id: 'd4a011b9337a4204',
    type: 'function',
  ...
  },
  {
    ...
    x: 490,
    y: 1960,
    wires: [['d4a011b9337a4403'], ['d4a011b9337a4404'], ['d4a011b9337a4405']],
  },
  {
    id: 'd4a011b9337a4403',
    type: 'http request',
    z: tabId,
    name: 'Viva split leave request',
    method: 'use',
    ret: 'obj',
    paytoqs: 'ignore',
    url: '',
  ...
  },
  {
    ...
    type: 'debug',
    z: tabId,
    name: 'lk games split leave debug',
    active: false,
    tosidebar: true,
    console: false,
    tostatus: false,
...

  {
    ...
    type: 'inject',
    z: tabId,
    name: 'Refresh tournament subscription counters',
    props: [
      { p: 'payload' },
      { p: 'topic', vt: 'str' },
    ],
    ...
    x: 210,
    y: 2120,
    wires: [['e5a1b2c3d4f54109']],
  },
  {
    id: 'e5a1b2c3d4f54109',
    type: 'function',
    z: tabId,
    name: 'Prepare tournament subscription counter refresh',
    func: fnTournamentSubscriptionCounterRefreshPrepare,
    outputs: 1,
    timeout: '',
    noerr: 0,
    initialize: '',
  ...
  },
  {
    ...
    z: tabId,
    mongodb: 'mongo_lk',
    name: 'Find tournament subscription sales for refresh',
    collection: 'lk_tournament_subscription_sales',
    operation: 'find',
    x: 850,
    y: 2120,
    wires: [['e5a1b2c3d4f54111']],
  },
  {
    id: 'e5a1b2c3d4f54111',
    type: 'function',
    z: tabId,
    name: 'Build tournament subscription counters',
    func: fnTournamentSubscriptionCounterRefreshResponse,
    outputs: 1,
    timeout: '',
    noerr: 0,
    initialize: '',
  ...
  },
  {
    ...
    z: tabId,
    mongodb: 'mongo_lk',
    name: 'Upsert tournament subscription counters',
    collection: 'lk_tournament_subscription_counters',
    payonly: false,
    upsert: true,
    multi: false,
    operation: 'update',
  ...
  },
  {
    ...
    type: 'comment',
    z: tabId,
    name: 'LK games composite namespace',
    info: 'Изолированный namespace для составных слотов. Не вмешивается в legacy split/create/payment flows.',
    x: 250,
    y: 2200,
    wires: [],
  },
  {
    ...
    type: 'http in',
    z: tabId,
    name: 'LK composite options',
    url: '/lk/games/composite/options',
    method: 'post',
    upload: false,
    swaggerDoc: '',
    x: 150,
    y: 2240,
    wires: [['f6c011b9337a4504']],
  },
  {
    id: 'f6c011b9337a4503',
    type: 'http in',
    z: tabId,
    name: 'LK composite options alias',
    url: '/lk/games/composite/options',
    method: 'get',
    upload: false,
    swaggerDoc: '',
  ...
  },
  {
    ...
    type: 'function',
    z: tabId,
    name: 'Build composite options',
    func: fnCompositeOptions,
    outputs: 2,
    timeout: '',
    noerr: 0,
    initialize: '',
    ...
    x: 430,
    y: 2260,
    wires: [['f6c011b9337a4505'], ['f6c011b9337a4506']],
  },
  {
    id: 'f6c011b9337a4505',
    type: 'http response',
  ...
  },
  {
    ...
    type: 'debug',
    z: tabId,
    name: 'lk composite options debug',
    active: false,
    tosidebar: true,
    console: false,
    tostatus: false,
  ...
  },
  {
    ...
    type: 'http in',
    z: tabId,
    name: 'LK composite create',
    url: '/lk/games/composite/create',
    method: 'post',
    upload: false,
    swaggerDoc: '',
    x: 150,
    y: 2360,
    wires: [['f6c011b9337a4508']],
  },
  {
    id: 'f6c011b9337a4508',
    type: 'function',
    z: tabId,
    name: 'Prepare composite create',
    func: fnCompositeCreate,
    outputs: 3,
    timeout: '',
    noerr: 0,
    initialize: '',
    ...
    x: 430,
    y: 2360,
    wires: [['f6c011b9337a4509'], ['f6c011b9337a4510'], ['f6c011b9337a4511']],
  },
  {
    id: 'f6c011b9337a4509',
    type: 'mongodb out',
    z: tabId,
    mongodb: 'mongo_lk',
    name: 'Upsert composite booking',
    collection: 'lk_game_composites',
    payonly: false,
    upsert: true,
    multi: false,
    operation: 'update',
  ...
  },
  {
    ...
    type: 'debug',
    z: tabId,
    name: 'lk composite create debug',
    active: false,
    tosidebar: true,
    console: false,
    tostatus: false,
  ...
  },
  {
    ...
    type: 'http in',
    z: tabId,
    name: 'LK composite confirm',
    url: '/lk/games/composite/confirm',
    method: 'post',
    upload: false,
    swaggerDoc: '',
    x: 150,
    y: 2460,
    wires: [['f6c011b9337a4514']],
  },
  {
    id: 'f6c011b9337a4513',
    type: 'http in',
    z: tabId,
    name: 'LK composite payment confirm',
    url: '/lk/games/composite/payment/confirm',
    method: 'post',
    upload: false,
    swaggerDoc: '',
    x: 170,
  ...
  },
  {
    ...
    type: 'function',
    z: tabId,
    name: 'Build composite confirm query',
    func: fnCompositeConfirmQuery,
    outputs: 3,
    timeout: '',
    noerr: 0,
    initialize: '',
    ...
    x: 460,
    y: 2480,
    wires: [['f6c011b9337a4515'], ['f6c011b9337a4518'], ['f6c011b9337a4519']],
  },
  {
    id: 'f6c011b9337a4515',
    type: 'mongodb in',
    z: tabId,
    mongodb: 'mongo_lk',
    name: 'Find composite booking',
    collection: 'lk_game_composites',
    operation: 'find',
    x: 740,
    y: 2480,
    wires: [['f6c011b9337a4516']],
  },
  {
    id: 'f6c011b9337a4516',
    type: 'function',
    z: tabId,
    name: 'Apply composite confirm',
    func: fnCompositeConfirmApply,
    outputs: 3,
    timeout: '',
    noerr: 0,
    initialize: '',
    ...
    x: 1010,
    y: 2480,
    wires: [['f6c011b9337a4517'], ['f6c011b9337a4518'], ['f6c011b9337a4519']],
  },
  {
    id: 'f6c011b9337a4517',
    type: 'mongodb out',
  ...
  },
  {
    ...
    type: 'debug',
    z: tabId,
    name: 'lk composite confirm debug',
    active: false,
    tosidebar: true,
    console: false,
    tostatus: false,
  ...
  },
  {
    ...
    type: 'http in',
    z: tabId,
    name: 'LK tournament subscription status',
    url: '/lk/tournaments/summer-subscription/status',
    method: 'get',
    upload: false,
    swaggerDoc: '',
    x: 180,
    y: 2200,
    wires: [['e5a1b2c3d4f54103']],
  },
  {
    id: 'e5a1b2c3d4f54103',
    type: 'function',
    ...
    func: fnTournamentSubscriptionStatusPrepare,
    outputs: 3,
    timeout: '',
    noerr: 0,
    initialize: '',
    ...
    x: 480,
    y: 2200,
    wires: [['e5a1b2c3d4f54104'], ['e5a1b2c3d4f54106'], ['e5a1b2c3d4f54107']],
  },
  {
    id: 'e5a1b2c3d4f54104',
    type: 'mongodb in',
    z: tabId,
    mongodb: 'mongo_lk',
    name: 'Find tournament subscription sales',
    collection: 'lk_tournament_subscription_sales',
    operation: 'find',
    x: 790,
    y: 2200,
    wires: [['e5a1b2c3d4f54105']],
  },
  {
    id: 'e5a1b2c3d4f54105',
    type: 'function',
    ...
    func: fnTournamentSubscriptionStatusResponse,
    outputs: 3,
    timeout: '',
    noerr: 0,
    initialize: '',
    ...
    x: 1080,
    y: 2200,
    wires: [['e5a1b2c3d4f54106'], ['e5a1b2c3d4f54107'], ['e5a1b2c3d4f54108']],
  },
  {
    id: 'e5a1b2c3d4f54106',
    type: 'http response',
  ...
  },
  {
    ...
    type: 'debug',
    z: tabId,
    name: 'tournament subscription status debug',
    active: false,
    tosidebar: true,
    console: false,
    tostatus: false,
  ...
  },
  {
    ...
    type: 'http in',
    z: tabId,
    name: 'LK tournament subscription purchase',
    url: '/lk/tournaments/summer-subscription/purchase',
    method: 'post',
    upload: false,
    swaggerDoc: '',
    x: 180,
    y: 2280,
    wires: [['e5a1b2c3d4f54202']],
  },
  {
    id: 'e5a1b2c3d4f54202',
    type: 'function',
    ...
    func: fnTournamentSubscriptionPurchasePrepare,
    outputs: 3,
    timeout: '',
    noerr: 0,
    initialize: '',
    ...
    x: 500,
    y: 2280,
    wires: [['e5a1b2c3d4f54203'], ['e5a1b2c3d4f54208'], ['e5a1b2c3d4f54209']],
  },
  {
    id: 'e5a1b2c3d4f54203',
    type: 'mongodb in',
    z: tabId,
    mongodb: 'mongo_lk',
    name: 'Find active tournament subscription reservations',
    collection: 'lk_tournament_subscription_sales',
    operation: 'find',
    x: 840,
    y: 2280,
    wires: [['e5a1b2c3d4f54204']],
  },
  {
    id: 'e5a1b2c3d4f54204',
    type: 'function',
    ...
    func: fnTournamentSubscriptionPurchaseLimit,
    outputs: 3,
    timeout: '',
    noerr: 0,
    initialize: '',
    ...
    x: 1160,
    y: 2280,
    wires: [['e5a1b2c3d4f54205'], ['e5a1b2c3d4f54208'], ['e5a1b2c3d4f54209']],
  },
  {
    id: 'e5a1b2c3d4f54205',
    type: 'http request',
    z: tabId,
    name: 'Viva tournament subscription request',
    method: 'use',
    ret: 'obj',
    paytoqs: 'ignore',
    url: '',
  ...
  },
  {
    ...
    func: fnTournamentSubscriptionPurchaseRouter,
    outputs: 4,
    timeout: '',
    noerr: 0,
    initialize: '',
    ...
    x: 1760,
    y: 2280,
    wires: [['e5a1b2c3d4f54205'], ['e5a1b2c3d4f54207'], ['e5a1b2c3d4f54208'], ['e5a1b2c3d4f54209']],
  },
  {
    id: 'e5a1b2c3d4f54207',
    type: 'mongodb out',
    z: tabId,
    mongodb: 'mongo_lk',
    name: 'Upsert tournament subscription sale',
    collection: 'lk_tournament_subscription_sales',
    payonly: false,
    upsert: true,
    multi: false,
  ...
  },
  {
    ...
    type: 'http in',
    z: tabId,
    name: 'LK tournament subscription confirm',
    url: '/lk/tournaments/summer-subscription/confirm',
    method: 'post',
    upload: false,
    swaggerDoc: '',
    x: 180,
    y: 2360,
    wires: [['e5a1b2c3d4f54302']],
  },
  {
    id: 'e5a1b2c3d4f54302',
    type: 'function',
    z: tabId,
    name: 'Prepare tournament subscription confirm',
    func: fnTournamentSubscriptionConfirmPrepare,
    outputs: 3,
    timeout: '',
    noerr: 0,
    initialize: '',
    ...
    x: 500,
    y: 2360,
    wires: [['e5a1b2c3d4f54303'], ['e5a1b2c3d4f54208'], ['e5a1b2c3d4f54209']],
  },
  {
    id: 'e5a1b2c3d4f54303',
    type: 'mongodb in',
    z: tabId,
    mongodb: 'mongo_lk',
    name: 'Find tournament subscription record by paymentRef',
    collection: 'lk_tournament_subscription_sales',
    operation: 'find',
    x: 860,
    y: 2360,
    wires: [['e5a1b2c3d4f54304']],
  },
  {
    id: 'e5a1b2c3d4f54304',
    type: 'function',
    ...
    func: fnTournamentSubscriptionConfirmResolve,
    outputs: 3,
    timeout: '',
    noerr: 0,
    initialize: '',
