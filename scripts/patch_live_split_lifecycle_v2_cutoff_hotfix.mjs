...
export const CONTRACT = Object.freeze({
  flowSha256: "0cd277f345e03ccb42e2dd2ba236cbfe5d72f59cf80a39e6815be7344007dfeb",
  nodeCount: 4762,
  httpRouteCount: 215,
  ...
  targets: [
    {
      ...
      beforeFuncSha256: "5974087b4fc4e30a3ea3f8857d2b35a95e78c630ae0b96e58236778dd9b3958e",
      afterFuncSha256: "5a9086fc840885d90c49469aed6e867e6ad5aaa7abc81a188e8b86e927298d1e",
    },
    {
      id: "9508f8e0ae8d282a",
      name: "Prepare split cleanup tasks",
      source: "fn_split_cleanup_prepare.js",
      beforeFuncSha256: "3103198d1afee50199a11a84c90062706a06810146a59060ce982d6a1a306ad2",
      afterFuncSha256: "988bacd186c89d3901a60ab01433c4a928aa860e452ad14253bb0515b614acd6",
    },
  ],
});
...
function parseArgs(argv) {
  ...
  if (!values["--input"] || !values["--output"] || !values["--report"]) {
    fail("Usage: node scripts/patch_live_split_lifecycle_v2_cutoff_hotfix.mjs --input FLOW --output CANDIDATE --report REPORT");
  }
  return values;
}
