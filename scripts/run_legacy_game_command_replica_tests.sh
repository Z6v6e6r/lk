...
container_name="padlhub-legacy-command-rs-test"
image_name="${LEGACY_COMMAND_MONGO_TEST_IMAGE:-mongo:7}"
...
LEGACY_COMMAND_TEST_MONGO_URI="mongodb://127.0.0.1:${host_port}/?directConnection=true" \
  node --test scripts/tests/legacyGameCommandPrerequisites.mongo.test.mjs
