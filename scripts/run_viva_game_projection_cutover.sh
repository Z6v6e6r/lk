...
if [[ -z "${PADLHUB_CUTOVER_GUARDIAN_RECEIPT:-}" || -z "${PADLHUB_CUTOVER_GUARDIAN_RELEASE_REQUEST:-}" || -z "${PADLHUB_CUTOVER_GUARDIAN_RECOVERY_REQUEST:-}" || -z "${PADLHUB_CUTOVER_GUARDIAN_HEARTBEAT:-}" ]]; then
  echo "PADLHUB_CUTOVER_GUARDIAN_RECEIPT, PADLHUB_CUTOVER_GUARDIAN_RELEASE_REQUEST, PADLHUB_CUTOVER_GUARDIAN_RECOVERY_REQUEST and PADLHUB_CUTOVER_GUARDIAN_HEARTBEAT are required" >&2
  exit 1
fi
