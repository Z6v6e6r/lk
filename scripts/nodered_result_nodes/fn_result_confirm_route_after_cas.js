...
const ratingsMsg = makeMsg(
  ratingMutations,
  syncBatch ? { _resultVivaSyncBatch: syncBatch } : {},
);
const gameMsg = bundle.gamePayload ? makeMsg(bundle.gamePayload) : null;
const responseMsg = bundle.response
  ? Object.assign({}, msg, {
...
const syncBatchMsg = syncBatch && ratingMutations.length === 0
  ? Object.assign({}, msg, {
