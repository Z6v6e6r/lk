...
const valueFlags = new Map([
  ...
  ["--reconciliation-packet", "reconciliationPacket"],
...
export function preparePacket(options, dependencies = {}) {
  ...
  const packet = buildPiterAtomicActivationPacket({
    ...
    reconciliationPacket: options.reconciliationPacket
      ? readProtectedJson(options.reconciliationPacket, "reconciliation packet", fsImpl)
      : null,
    reconciliationApplyReceipt: options.reconciliationReceipt
